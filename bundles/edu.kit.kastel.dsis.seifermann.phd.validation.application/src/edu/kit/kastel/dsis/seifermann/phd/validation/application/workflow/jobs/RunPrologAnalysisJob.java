...
public abstract class RunPrologAnalysisJob extends AbstractBlackboardInteractingJob<Blackboard<Object>> {
    ...
    public RunPrologAnalysisJob(String resultKey, URL queryRulesLocation, URL queryLocation) {
        this.resultKey = resultKey;
        this.queryRulesLocation = queryRulesLocation;
        this.queryLocation = queryLocation;
    }
    
    protected abstract String generatePrologProgram();
    ...
    public void execute(IProgressMonitor monitor) throws JobFailedException, UserCanceledException {
        ...
        var prologProgram = generatePrologProgram();
        monitor.worked(1);
