...
public class DistanceTracker_HL_CF extends PCMModelBase {

    public DistanceTracker_HL_CF() {
        super(2, "DistanceTracker", ConfidentialityMechanism.NonInterferenceLinear, CommunicationParadigm.CONTROL_FLOW,
                "DistanceTracker_CallReturn_HL", "newUsageModel.usagemodel", "newUsageModel_withIssue.usagemodel",
