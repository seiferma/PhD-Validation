...
public class Hospital_HL_CF extends PCMModelBase {

    public Hospital_HL_CF() {
        super(7, "Hospital", ConfidentialityMechanism.NonInterferenceLinearWithEncryption,
                CommunicationParadigm.CONTROL_FLOW, "Hospital_CallReturn_HL", "newUsageModel.usagemodel",
