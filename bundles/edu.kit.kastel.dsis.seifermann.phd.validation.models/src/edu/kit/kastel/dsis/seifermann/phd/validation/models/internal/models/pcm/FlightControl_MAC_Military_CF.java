...
public class FlightControl_MAC_Military_CF extends PCMModelBase {

    public FlightControl_MAC_Military_CF() {
        super(14, "FlightControl", ConfidentialityMechanism.MAC_Military, CommunicationParadigm.CONTROL_FLOW,
                "FlightControl_CallReturn_MAC_Military", "newUsageModel.usagemodel", "newUsageModel_withIssue.usagemodel",
    ...
    public boolean isAcceptableViolation(Map<String, Object> violation) {
        ...
        var nodeIsCivilFlightPlanner = nodeId.contains("CivilFlightPlanner") || nodeId.contains("CivilRouteCalculation");
