...
public class TravelPlanner_TMAC_DF extends PCMModelBase {

    public TravelPlanner_TMAC_DF() {
        super(17, "TravelPlanner", ConfidentialityMechanism.RBAC_TAINT, CommunicationParadigm.DATA_FLOW,
                "TravelPlanner_DataFlow_TMAC", "newUsageModel.usagemodel", "newUsageModel_withIssue.usagemodel",
    ...
    public boolean isAcceptableViolation(Map<String, Object> violation) {
        ...
        var isFindFlights = nodeId.contains("TravelAgencyQueryBuilder") || nodeId.contains("AirlineFlightSelector");
