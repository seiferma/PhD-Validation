...
public class TravelPlanner_RBAC_CF extends PCMModelBase {

    public TravelPlanner_RBAC_CF() {
        super(10, "TravelPlanner", ConfidentialityMechanism.RBAC, CommunicationParadigm.CONTROL_FLOW,
                "TravelPlanner_CallReturn_RBAC", "newUsageModel.usagemodel", "newUsageModel_withIssue.usagemodel",
    ...
    public boolean isAcceptableViolation(Map<String, Object> violation) {
        ...
        var isBookingNode = nodeId.contains("bookFlight");
        var isBookingStorageNode = nodeId.contains("Assembly_BookingStorage");
